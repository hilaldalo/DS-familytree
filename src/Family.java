...
public class Family {
	...
	public void addBro(int personId, String bro, int broId) {
		...
		if (temp == null) {
			Print.red(Messages.NO_ONE_NAME + "\n");
		}
	...
	public void delete(Person person) {
		...
		if (temp.father.bigSon.id == person.id) {
			...
			Print.green(Messages.PERSON_DELETED + "\n");
			return;
		}
